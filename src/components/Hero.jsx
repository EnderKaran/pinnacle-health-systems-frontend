...
const Hero = () => {
  return (
    <section 
      ...
      className="relative w-full h-[650px] sm:h-[700px] md:h-[700px] bg-cover bg-center pt-16 sm:pt-20" 
    ...
    >
      ...
      {/* İçerik Alanı */}
      <div className="relative container mx-auto px-4 h-full flex flex-col justify-start md:justify-center items-center text-center md:items-start md:text-left">
        {/* Başlık ve Alt Başlık */}
        <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold text-gray-800 leading-tight mt-6 md:mt-0">
          Sağlığınız için <br className="hidden sm:inline-block" /> doğru uzmanı bulun
        </h1>
        <p className="mt-4 text-sm sm:text-base md:text-lg text-gray-600 max-w-lg px-2 sm:px-0">
        ...
        <div className="mt-8 md:mt-16 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 text-center w-full max-w-sm sm:max-w-4xl">
          <div className="flex flex-col items-center p-3 sm:p-0"> 
            ...
            <h3 className="mt-3 sm:mt-4 text-lg sm:text-xl font-semibold text-gray-800">10,000+ Uzman Doktor</h3>
            <p className="mt-1 text-sm sm:text-base text-gray-600 px-2">Türkiye'nin her yerinden uzman doktorlarla buluşun.</p>
          </div>
          <div className="flex flex-col items-center p-3 sm:p-0">
            <div className="p-3 sm:p-4 bg-teal-100/70 rounded-full"><FaCalendarCheck className="w-7 h-7 sm:w-8 sm:h-8 text-teal-600" /></div>
            <h3 className="mt-3 sm:mt-4 text-lg sm:text-xl font-semibold text-gray-800">Anında Randevu</h3>
            <p className="mt-1 text-sm sm:text-base text-gray-600 px-2">24/7 online randevu alma imkanı.</p>
          </div>
          <div className="flex flex-col items-center p-3 sm:p-0">
            <div className="p-3 sm:p-4 bg-green-100/70 rounded-full"><FaShieldAlt className="w-7 h-7 sm:w-8 sm:h-8 text-green-600" /></div>
            <h3 className="mt-3 sm:mt-4 text-lg sm:text-xl font-semibold text-gray-800">Güvenli Platform</h3>
            <p className="mt-1 text-sm sm:text-base text-gray-600 px-2">Kişisel verileriniz tamamen güvende.</p>
          </div>
        </div>
      </div>
    </section>
